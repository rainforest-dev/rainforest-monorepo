...
<article className="prose dark:prose-dark w-full rounded border border-dashed px-4 py-3">
  <h1 className="h-lh skeleton-surface-container-high w-1/2"></h1>
  <h2 className="h-lh skeleton-surface-container-high w-1/3"></h2>
  <h3 className="h-lh flex-row-center w-2/3 gap-2">
    <div className="skeleton-surface-container aspect-square h-full"></div>
    <span className="skeleton-surface-container size-full"></span>
  </h3>
  <p className="h-5lh skeleton-surface-container w-full"></p>
</article>
