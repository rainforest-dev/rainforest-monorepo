...
// Mirrors the real rainforest-angible snapshot (plan team; claude 5h + weekly-all,
...
describe('parseMachineBudget', () => {
  it('parses the nested Claude/Codex shape with plan, buckets and stale_minutes', () => {
    ...
    expect(mb.machine).toBe('rainforest-angible');
