...
/** A modal window. Compose DialogTrigger with DialogContent, DialogHeader and DialogFooter. */
...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Backdrop
      ...
      className={cn(
        'supports-backdrop-filter:backdrop-blur-xs data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0 bg-foreground/10 fixed inset-0 isolate z-50 duration-100',
        className,
      )}
      {...props}
    />
