...
/** Switches between panels. Compose TabsList, TabsTrigger and TabsContent. */
function Tabs({
  className,
  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        'group-data-[variant=line]/tabs-list:data-active:bg-transparent group-data-[variant=line]/tabs-list:bg-transparent',
