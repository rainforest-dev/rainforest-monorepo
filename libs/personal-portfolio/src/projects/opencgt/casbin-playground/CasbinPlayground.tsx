  ...
  return (
    <div className="border-border bg-card text-card-foreground rounded-xl border p-6">
      <div className="flex flex-wrap items-end gap-3">
        <label className="text-sm">
          ...
          <select
            ...
            className="border-border bg-background text-foreground focus-visible:ring-ring focus-visible:ring-offset-background h-9 min-w-52 rounded-md border pl-2 pr-8 font-mono text-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
          >
            {SUBJECTS.map((option) => (
        ...
        <label className="text-sm">
          ...
          <select
            ...
            className="border-border bg-background text-foreground focus-visible:ring-ring focus-visible:ring-offset-background h-9 min-w-40 rounded-md border pl-2 pr-8 font-mono text-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
          >
            {OBJECTS.map((option) => (
              <option key={option} value={option}>
                {option}
        ...
        <label className="text-sm">
          ...
          <select
            ...
            className="border-border bg-background text-foreground focus-visible:ring-ring focus-visible:ring-offset-background h-9 min-w-28 rounded-md border pl-2 pr-8 font-mono text-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
          >
            {ACTIONS.map((option) => (
              <option key={option} value={option}>
                {option}
      ...
      <div className="border-border mt-4 overflow-hidden rounded-lg border">
        <div className="bg-muted/40 text-muted-foreground grid grid-cols-[1.3fr_1.3fr_1fr_1.8fr] px-3 py-2 text-[11px] uppercase tracking-wide">
          <span>p.sub</span>
          <span>p.obj</span>
          <span>p.act</span>
          <span>matcher</span>
            ...
            <span>
              {row.policy.fixed ? (
                ...
                <select
                  ...
                  className="border-border bg-background focus-visible:ring-ring h-7 min-w-24 rounded-md border pl-1.5 pr-7 font-mono text-xs transition-colors focus-visible:outline-none focus-visible:ring-2"
                >
